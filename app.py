...
def handle_query(query, embedding, vector_db, router):
    ...
    # TTS
    audio_bytes = text_to_speech(assistant_reply)
    st.audio(audio_bytes, format="audio/wav")

# ---------- Giao diện Streamlit ----------
st.set_page_config(page_title="Tư vấn Hiếu Phone", page_icon="📱", layout="centered")
st.title("📞 Chatbot Tư vấn Hiếu Phone")

...
async def process_query(request: ChatRequest):
    try:
        ...
        final_res = await client.chat.completions.create(
            model="gpt-4o-mini",
            messages=[
                {"role": "system", "content": "Bạn là AI tên Sen. Trả lời thân thiện dựa trên CONTEXT. Nếu không có thông tin, hãy xin lỗi."},
...
@app.get("/")
async def root():
    return {"message": "AI Sen API is online!", "mode": "OpenAI-Lightweight"}
